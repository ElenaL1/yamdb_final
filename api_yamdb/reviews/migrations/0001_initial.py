    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('confirmation_code', models.CharField(default='XXXX', max_length=255, verbose_name='код подтверждения')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('score', models.PositiveSmallIntegerField(validators=[django.core.validators.MinValueValidator(1, 'Только значения от 1 до 10'), django.core.validators.MaxValueValidator(10, 'Только значения от 1 до 10')], verbose_name='Рейтинг')),
